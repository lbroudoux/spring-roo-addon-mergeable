...
@Service
public class MergeableCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    
    /**
     * Get a reference to the MergeableOperations from the underlying OSGi container
     */
    @Reference private MergeableOperations operations;
     ...
     */
    @CliAvailabilityIndicator({ "mergeable setup", "mergeable add", "mergeable all" })
     ...
     * @param type 
     */
    @CliCommand(value = "mergeable add", help = "Some helpful description")
     ...
     * 
     */
    @CliCommand(value = "mergeable all", help = "Some helpful description")
    public void all() {
     ...
     * 
     */
    @CliCommand(value = "mergeable setup", help = "Setup Mergeable addon")
    public void setup() {
        operations.setup();
    }
}
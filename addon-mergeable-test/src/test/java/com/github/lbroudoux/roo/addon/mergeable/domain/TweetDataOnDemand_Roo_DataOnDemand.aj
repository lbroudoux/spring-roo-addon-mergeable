...
import com.github.lbroudoux.roo.addon.mergeable.domain.TweetDataOnDemand;
...
privileged aspect TweetDataOnDemand_Roo_DataOnDemand {
    ...
    public void TweetDataOnDemand.setOriginal(Tweet obj, int index) {
        Tweet original = obj;
